...
// console.log(Number.parseInt('e23', 10)); // not work not begin with number
...
// //Rounding decimals
// console.log((2.7).toFixed(0)); //3 строка
// console.log((2.7).toFixed(3)); //2.700 строка
// console.log((2.345).toFixed(2)); //2.35 строка
// console.log(+(2.345).toFixed(2)); //2ю35 число
